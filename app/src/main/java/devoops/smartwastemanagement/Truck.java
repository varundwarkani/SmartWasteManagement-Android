...
public class Truck extends AppCompatActivity implements OnMapReadyCallback {
    ...
    LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                databaseReference.child("city/Chennai/key/lat").setValue(currentlat);
                databaseReference.child("city/Chennai/key/lon").setValue(currentlon);
                Toast.makeText(Truck.this, "Location updated!", Toast.LENGTH_SHORT).show();
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(Truck.this,
