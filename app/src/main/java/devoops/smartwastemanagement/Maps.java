...
public class Maps extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    FirebaseDatabase.getInstance().getReference().child("city/"+"Chennai")
                            .addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                        ...
                                        if (distance<2)
                                        {
                                            Toast.makeText(Maps.this, "Vehicle is within 2 KM", Toast.LENGTH_SHORT).show();
                                            NotificationCompat.Builder mBuilder =
                                                    new NotificationCompat.Builder(Maps.this);
    ...
    private void addCustomMarker(Double lati, Double longi, String name) {
        if (mMap == null) {
            return;
        }
