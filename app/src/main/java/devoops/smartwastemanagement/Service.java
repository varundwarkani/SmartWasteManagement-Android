...
public class Service extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvcomplaint.setLayoutManager(new LinearLayoutManager(Service.this));
        serviceAdapter = new ServiceAdapter(tvDesc,tvStatus,tvCurrently,tvDate,tvUid,tvDatee);
        rvcomplaint.setAdapter(serviceAdapter);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    uid = user.getUid();
                    DatabaseReference usersRef = FirebaseDatabase.getInstance().getReference("complaint/garbage/Chennai/key/service");
